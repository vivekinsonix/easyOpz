    ...
    return (
        <section id="pricing" className="container mx-auto py-20 px-6 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {plans.map((plan, i) => (
                    <div key={i} className={`cursor-pointer rounded-lg p-6 shadow-md ${plan.highlight ? "bg-secondary text-white border-2 border-secondary" : "bg-white text-gray-900"}`}>
                        ...
                        <button className={`cursor-pointer mt-6 px-6 py-2 rounded-md font-semibold ${plan.highlight ? "bg-highlight text-black hover:bg-yellow-500" : "bg-secondary text-white hover:bg-secondary/80"}`}>
